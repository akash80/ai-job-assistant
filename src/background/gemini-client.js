...
export async function generateTailoredResumeGemini(requestJson, apiConfig) {
  const response = await callGemini(
    [
  ...
  try {
    ...
    throw new GeminiError("Failed to parse Gemini tailored resume as JSON", "PARSE_ERROR");
  }
